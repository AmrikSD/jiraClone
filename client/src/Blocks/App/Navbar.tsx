    ...
    return (
      <nav className='navbar'>
        <ul className='navbar-nav'>
          <li className='logo'>
            <a href='/fucktoyou' className='nav-link'>
              <span className='link-text logo-text'>wowee!</span>
              <svg
                aria-hidden='true'
                focusable='false'
                data-prefix='fad'
          ...
          <li className='nav-item'>
            <a href='/andyou' className='nav-link'>
              <svg
                aria-hidden='true'
                focusable='false'
                data-prefix='fad'
          ...
          <li className='nav-item'>
            <a href='/youtoo!' className='nav-link'>
              <svg
                aria-hidden='true'
                focusable='false'
                data-prefix='fad'
          ...
          <li className='nav-item'>
            <a href='/woweeyoutoo!' className='nav-link'>
              <svg
                aria-hidden='true'
                focusable='false'
                data-prefix='fad'
          ...
          <li className='nav-item'>
            <a href='/tscansuckmyballs' className='nav-link'>
              <svg
                aria-hidden='true'
                focusable='false'
                data-prefix='fad'
